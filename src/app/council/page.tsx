...
const councilMembers: CouncilMember[] = [
    ...
    { name: 'Promise Isaac O', title: 'Immediate President', org: 'JCIN OAU', image: '/images/council/promise_isaac_o.png', bio: "A dedicated member of the 2025 Collegiate Council, committed to the 'Ascend' vision and empowering JCI members." },
    { name: 'Orimogunje Josephine', title: 'Director', org: 'JCIN Chapter', image: '/images/council/orimogunje_josephine.png', bio: "A dedicated member of the 2025 Collegiate Council, committed to the 'Ascend' vision and empowering JCI members." },
    ...
    { name: 'Akande Moses', title: 'Director', org: 'JCIN Chapter', image: '/images/council/akande_moses.png', bio: "A dedicated member of the 2025 Collegiate Council, committed to the 'Ascend' vision and empowering JCI members." },
    { name: 'Yakubu ToHBi', title: 'Director', org: 'JCIN Chapter', image: '/images/council/yakubu_tohbi.png', bio: "A dedicated member of the 2025 Collegiate Council, committed to the 'Ascend' vision and empowering JCI members." },
    { name: 'Falope Oluwafunke', title: 'Director', org: 'JCIN Chapter', image: '/images/council/falope_oluwafunke.png', bio: "A dedicated member of the 2025 Collegiate Council, committed to the 'Ascend' vision and empowering JCI members." },
    { name: 'Emmanuel Nelson', title: 'Director', org: 'JCIN Chapter', image: '/images/council/emmanuel_nelson.png', bio: "A dedicated member of the 2025 Collegiate Council, committed to the 'Ascend' vision and empowering JCI members." },
];
