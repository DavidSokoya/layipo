            ...
            <Card className="transition-all duration-300 hover:shadow-lg hover:border-primary/50 h-full p-4 flex flex-col">
                <div className="flex-grow">
                    <div className="flex items-start gap-3">
                        ...
                        <p className="font-semibold text-base leading-tight group-hover:text-primary transition-colors flex-1">{event.title}</p>
                    </div>
                </div>
                <div className="flex items-center text-xs text-muted-foreground pt-3 mt-auto pl-8">
